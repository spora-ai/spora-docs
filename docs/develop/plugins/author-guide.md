...
description: End-to-end guide for writing a Spora plugin — Composer package, manifest, tools, drivers, migrations, admin UI, agent templates, distribution.
---
...
Skip [LLM drivers](/develop/plugins/author-guide/drivers), [Migrations](/develop/plugins/author-guide/migrations), and [Agent templates](/develop/plugins/author-guide/agent-templates) on first read — they are independent and can be picked up when needed. [Distribution](/develop/plugins/author-guide/distribution) is for after you have working code on `main` and want to ship it.
